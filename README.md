...
I grew tired of repeating myself myself.  This library is built to generate HTML forms via a reusable libarary.
I got tired of Symfonic noise with no docs.  Why you no document your code?  I needed something that was not
dependent on an underlying framework.  Without further ado...
...
If the HTML generated by these functions is not meeting your needs, you can override it in one of two ways:
