...
class Validator {
	 ...
	 *
	 * @param  array  $rules
	 * @param  array  $values (usually $_POST or $_GET)
	 * @return array
	 */
	public static function check($rules,$values)
	{
        self::$errors = array(); // reset
     ...
     *
     * 'fieldname' => array(
     *       array('function', array('param1','param2'))
     *   )
     *
     *
	 * @param  array  $rules
	...
	{
        if (!is_array($rules)) throw new Exception('Validator rules must be an array.');
		...
		foreach ($rules as $key => $value) {
            ...
            foreach ($rules as $r) {
                ...
                $parts = explode(':', $r, 2);
                if (isset($parts[0])) $functionname = $parts[0];
                if (isset($parts[1])) {
                    $parameter = $parts[0];
                }
                else {
                ...
                $params = str_getcsv($parameter);
                if (method_exists('\\Formbuilder\\Validator',$functionname)) {
                    $out[$key][] = array('\\Formbuilder\\Validator::'.$functionname, $params);                
                }
                else {
                    $out[$key][] = array($functionname, $params);
                }
            }
		}
	 ...
	 * @return bool
	 */
	public function Filled($attribute, $value)
	{
	 ...
	 * @return bool
	 */
	public function RequiredWith($attribute, $value, $parameters)
	{
	 ...
	 * @return bool
	 */
	public function RequiredWithAll($attribute, $value, $parameters)
	{
	 ...
	 * @return bool
	 */
	public function RequiredWithout($attribute, $value, $parameters)
	{
		if ($this->anyFailingRequired($parameters))
		{
			return $this->validateRequired($attribute, $value);
	 ...
	 * @return bool
	 */
	public function RequiredWithoutAll($attribute, $value, $parameters)
	{
		if ($this->allFailingRequired($parameters))
		{
			return $this->validateRequired($attribute, $value);
	 ...
	 * @return bool
	 */
	public function RequiredIf($attribute, $value, $parameters)
	{
	 ...
	 * @return bool
	 */
	public function Confirmed($attribute, $value)
	{
	 ...
	 * @return bool
	 */
	public function Same($attribute, $value, $parameters)
	{
	 ...
	 * @return bool
	 */
	public function Different($attribute, $value, $parameters)
	{
	 ...
	 * @return bool
	 */
	public function Accepted($attribute, $value)
	{
	 ...
	 * @return bool
	 */
	public function Numeric($attribute, $value)
	{
	 ...
	 * @return bool
	 */
	public function Digits($attribute, $value, $parameters)
	{
	 ...
	 * @return bool
	 */
	public function DigitsBetween($attribute, $value, $parameters)
	{
	 ...
	 * @return bool
	 */
	public function Size($attribute, $value, $parameters)
	{
	 ...
	 * @return bool
	 */
	public function Between($attribute, $value, $parameters)
	{
	 ...
	 * @return bool
	 */
	public function Min($attribute, $value, $parameters)
	{
	 ...
	 * @return bool
	 */
	public function Max($attribute, $value, $parameters)
	{
	 ...
	 * @return bool
	 */
	public function In($attribute, $value, $parameters)
	{
	 ...
	 * @return bool
	 */
	public function NotIn($attribute, $value, $parameters)
	{
		return ! in_array((string) $value, $parameters);
	}
	 ...
	 * @return bool
	 */
	public function Exists($attribute, $value, $parameters)
	{
	 ...
	 * @return bool
	 */
	public function Ip($attribute, $value)
	{
	 ...
	 * @return bool
	 */
	public function ActiveUrl($attribute, $value)
	{
	 ...
	 * @return bool
	 */
	public function Image($attribute, $value)
	{
	 ...
	 * @return bool
	 */
	public function Mimes($attribute, $value, $parameters)
	{
	 ...
	 * @return bool
	 */
	public function AlphaDash($attribute, $value)
	{
	 ...
	 * @return bool
	 */
	public function Regex($attribute, $value, $parameters)
	{
	 ...
	 * @return bool
	 */
	public function Date($attribute, $value)
	{
	 ...
	 * @return bool
	 */
	public function DateFormat($attribute, $value, $parameters)
	{
	 ...
	 * @return bool
	 */
	public function Before($attribute, $value, $parameters)
	{
	 ...
	 * @return bool
	 */
	public function After($attribute, $value, $parameters)
	{
